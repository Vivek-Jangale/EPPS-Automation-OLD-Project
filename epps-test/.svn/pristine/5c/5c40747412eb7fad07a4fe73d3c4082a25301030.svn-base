...
public class PQMSMasters extends BaseClass{
	...
	@Test(priority = 0)
	public void testProcessMaster() throws Exception {
		Thread.sleep(2000);
		ParsingExcel userData = new ParsingExcel("testdata/PQMS-Master.xlsx", "ProcessMaster");
		autoTestUtil.performAction(userData);
	}
	
	@Test(priority = 1)
		public void testProcessTypeMaster() throws Exception {
			Thread.sleep(2000);
			ParsingExcel userData = new ParsingExcel("testdata/PQMS-Master.xlsx", "ProcessTypeMaster");
			autoTestUtil.performAction(userData);
		}
	...
	@Test(priority = 2)
		public void testManPowerAllocation() throws Exception {
			Thread.sleep(2000);
			ParsingExcel userData = new ParsingExcel("testdata/PQMS-Master.xlsx", "ManPowerAllocation");
			autoTestUtil.performAction(userData);
		}	
