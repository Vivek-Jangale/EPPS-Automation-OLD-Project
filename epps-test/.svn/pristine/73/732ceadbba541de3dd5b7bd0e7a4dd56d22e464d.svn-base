...
public class BankMaster extends BaseClass{
	...
	@Test(priority = 0)
	public void testBankMaster() throws Exception {
		Thread.sleep(2000);
		ParsingExcel userData = new ParsingExcel("testdata/FAS-Master.xlsx", "BankMaster");
