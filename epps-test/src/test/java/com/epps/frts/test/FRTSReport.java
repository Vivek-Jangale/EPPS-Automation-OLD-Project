...
public class FRTSReport {
	...
	@Test(priority = 0)
	public void testExcelToExportFRTBPA() throws Exception {
		Thread.sleep(2000);
		ParsingExcel userData = new ParsingExcel("testdata/FRTS.xlsx", "E2EFrtsBPA");
		autoTestUtil.performAction(userData);
	}
	@Test(priority = 1)
	public void testFreightContractRPT() throws Exception {
		Thread.sleep(2000);
		ParsingExcel userData = new ParsingExcel("testdata/FRTS.xlsx", "FRTConRpt");
		autoTestUtil.performAction(userData);
