...
public class WSMSMaster extends BaseClass {
    ...
    @Test(priority = 0)
	public void testWarrantyGroupMaster() throws Exception{

			Thread.sleep(2000);
			ParsingExcel userData = new ParsingExcel("testdata/WSMS.xlsx", "WarrantyGroupMaster");
