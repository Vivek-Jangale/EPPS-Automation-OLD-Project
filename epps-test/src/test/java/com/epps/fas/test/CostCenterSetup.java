...
public class CostCenterSetup extends BaseClass{
	...
	@Test(priority = 0)
	public void testCostCenterCategory() throws Exception {
		Thread.sleep(2000);
		ParsingExcel userData = new ParsingExcel("testdata/FAS-Master.xlsx", "CostCenterCategory");
		autoTestUtil.performAction(userData);
	}
	
	@Test(priority = 1)
	public void testCostCenterHeads() throws Exception {
		Thread.sleep(2000);
		ParsingExcel userData = new ParsingExcel("testdata/FAS-Master.xlsx", "CostCenterHeads");
		autoTestUtil.performAction(userData);
	}
	
	@Test(priority = 2)
	public void testCostCenterGLLink() throws Exception {
		Thread.sleep(2000);
		ParsingExcel userData = new ParsingExcel("testdata/FAS-Master.xlsx", "CostCenterGLLink");
		autoTestUtil.performAction(userData);
	}
	
	@Test(priority = 3)
	public void testCostCenterHeadsLocationLink() throws Exception {
		Thread.sleep(2000);
		ParsingExcel userData = new ParsingExcel("testdata/FAS-Master.xlsx", "CostCenterHeadsLocationLink");
		autoTestUtil.performAction(userData);
	}
